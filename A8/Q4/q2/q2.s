...
.pos 0x300
    ...
    add  r4, r3                 # r3 = arr[0] - 8
    bgt  r3, L6                 # if (arr[0] > 8)  goto L6 (default case)
    ld   $0x400, r3             # r3 = address of jump table
    ld   (r3, r0, 4), r3        # load jmptable[arr[0]]
    j    (r3)                   # goto jmptable[arr[0]]
.pos 0x330
A0:
...
A2:
    ...
    inc  r2                     # r2 = -r2
    add  r1, r2                 # r2 = arr[1] - arr[2]
    bgt  r2, L0                 # if (arr[1] > arr[2]) goto L2
A3:
    ld   $0x0, r2               # r2 = 0
    br   L1                     # goto L1
L0:
